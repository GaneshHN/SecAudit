            ...
            <>
              ...
              <div className="space-y-3 mb-6">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-white text-gray-900 rounded-lg text-sm font-semibold opacity-40 cursor-not-allowed select-none"
                >
                  <GoogleIcon />
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-surface-800 text-white rounded-lg text-sm font-semibold border border-surface-700/50 opacity-40 cursor-not-allowed select-none"
                >
